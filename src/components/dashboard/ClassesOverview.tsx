...
import { Course, AttendanceReport } from '@/types/student';
import { Calendar, MapPin, Clock, Users, TrendingUp, Eye } from 'lucide-react';
...
const generateAttendanceReports = (courseId: string): AttendanceReport[] => {
  ...
  for (let i = 6; i >= 0; i--) {
    ...
    const total = Math.floor(Math.random() * 10) + 25; // 25-35 students
            ...
            <div key={course.id} className="bg-white/5 rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-colors">
              ...
              {selectedCourse === course.id && (
                <div className="mt-6 pt-6 border-t border-white/10">
                  <h4 className="text-lg font-semibold text-white mb-4">Weekly Attendance Reports</h4>
